...
fileName="small-step-responses-fd";
overLeafFilePath="img/small-step-responses-fd/";
...
%     hold off
    ...
    caption="Wykresy skoku jednostkowego zakłócenia Fd przy Fh[$"+"\\"+"frac{cm^3}{s}$]: "+Fh +" i  Fc[$"+"\\frac{cm^3}{s}$]: "+Fcin;
    label="fig:stepResponsesFhFd"; 
    
    saveFiguresInColumn([heightFigure,tempFigure], path,[heightName,tempName],fileName,overLeafFilePath,caption,label);
