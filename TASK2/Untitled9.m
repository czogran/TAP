...
CD=sys_dyskr.C;
[M,CtAt,CtV]=MPCSmatrices(AD, B1_dyskr, CD, N, Nu);

[nx, nu]=size(B1_dyskr); ny=size(CD,1);
...
for k = 200 : sim_len-N
    ...
    %Error.
    v(:,k)=x(:,k)-(AD*x(:,k-1)+B1_dyskr*[u(1,k-1);u(2,k-1-floor(k-delayC/Ts))] + B2_dyskr*[FD(1,k-1)-Fd0;TD(1,k-1)-Td0]);
